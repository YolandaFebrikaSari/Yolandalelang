<div class="container">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<a href="<?= base_url('admin/data_barang/tambah_barang') ?>" class="btn btn-sm btn-warning float-right">Tambahkan barang</a>
			</div>
				...
				<table class="table table-hover table-bordered">
					...
					foreach ($tb_barang as $brg) : ?>
						<tr>
							...
							<td>
								<a href="<?= base_url('admin/data_barang/edit/' . $brg->id_barang) ?>" class="btn btn-sm btn-primary">Edit</a>
