						...
						<div class="col-lg">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="">
									...
									<div class="form-group">
										<input type="text" name="fullname" id="fullname" class="form-control form-control-user form-control-user" value="<?php echo set_value('fullname');?>" placeholder="nama lengkap">
									<?php echo form_error('fullname') ?>
										</div>
			
									<div class="form-group ">
										<input type="text" name="username" id="username" class="form-control form-control-user" value="<?php echo set_value('username');?>" placeholder="nama">
										<?php echo form_error('username') ?>
									</div>
								...
								<div class="form-group col-sm-6">
										<input type="password" name="repassword" id="repassword" class="form-control form-control-user" placeholder="kata sandi ulang">
										<?php echo form_error('repassword') ?>
								</div>

								<div class="form-group col-sm-12">
										<input type="text" name="telp" id="telp" class="form-control form-control-user" placeholder="nomor telp">
