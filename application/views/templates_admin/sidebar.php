        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active ">
                <a class="nav-link" href="<?= base_url('admin/administrator'); ?>">
                    <i class="fas fa-fw fa-box"></i>Dashboard
                </a>
            </li>
            <hr class="sidebar-divider my-0">
            <!-- Nav Item - Data Admin -->
            <li class="nav-item active ">
                <a class="nav-link" href="<?= base_url('admin/data_admin'); ?>">
                    <i class="fas fa-fw fa-users"></i>Data Admin
                </a>
            </li>
            <hr class="sidebar-divider my-0">
            ...
            <li class="nav-item active ">
                <a class="nav-link" href="<?= base_url('admin/data_masyarakat'); ?>">
                    <i class="fas fa-fw fa-clipboard"></i>Data Masyarakat
                </a>
            </li>
            <hr class="sidebar-divider my-0">
            <!-- Nav Item - Data Barang -->
            ...
            <li class="nav-item active ">
                <a class="nav-link" href="<?= base_url('admin/laporan'); ?>">
                    <i class="fas fa-fw fa-book-open"></i>Laporan Lelang Ditutup
                </a>
            </li>
            ...
            <li class="nav-item active ">
                <a class="nav-link" href="<?= base_url('admin/laporan/laporan_barang'); ?>">
                    <i class="fas fa-fw fa-book-open"></i>Laporan Barang
                </a>
            </li>
            ...
            <li class="nav-item active ">
                <a class="nav-link" href="<?= base_url('admin/laporan_masyarakat'); ?>">
                    <i class="fas fa-fw fa-book-open"></i>Laporan Masyarakat
                </a>
            </li>
